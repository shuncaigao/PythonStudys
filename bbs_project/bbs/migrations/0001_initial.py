# -*- coding: utf-8 -*-
# Generated by Django 1.9.11 on 2017-03-27 13:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brief', models.TextField(default='none......', max_length=512)),
                ('content', models.TextField(max_length=100000)),
                ('pub_date', models.DateTimeField(blank=True, null=True)),
                ('last_modify', models.DateTimeField(auto_now=True)),
                ('priority', models.IntegerField(default=1000, verbose_name='优先级')),
                ('status', models.CharField(choices=[('draft', '草稿'), ('published', '已发布'), ('hidden', '隐藏')], default='published', max_length=250)),
